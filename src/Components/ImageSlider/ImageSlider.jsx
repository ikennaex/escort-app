...
import { CheckBadgeIcon, MapPinIcon, PhoneIcon } from '@heroicons/react/24/solid'
  ...
  return (
    <div className='container mx-auto p-4'>
        <div className='bg-customGray rounded-xl'>
            <img className='w-full h-96 object-cover' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2apztSw2a9Nzw3jedprGNLItfXNrf2jI_cw&s" alt="image slider" />
<div className="text-white p-4 rounded-lg shadow-md max-w-sm">
  ...
  <div className="flex items-center gap-2 mb-2">
    ...
    <a href="tel:+2347053333484" className="text-blue-600 hover:underline">
      +234 705 333 3484
    </a>
  </div>
